...
const ListOpenApiInfo: React.FC = () => {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      try {
        setRequestParams(requestParams ? JSON.parse(res.data.requestParams) : []);
        setResponseParams(responseParams ? JSON.parse(res.data.responseParams) : []);
        console.log("gffsdfdsaf")
