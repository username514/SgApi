...
import com.sg.sgapibackend.model.dto.interfaceinfo.*;
import com.sg.sgapibackend.model.enums.InterfaceInfoStatusEnum;
...
import com.sg.sgapicommon.model.vo.InterfaceInfoVO;
...
public class InterfaceInfoController {
    ...
    @PostMapping("/online")
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    public BaseResponse<Boolean> onlineInterfaceInfo(@RequestBody IdRequest idRequest) throws SgApiException {
        // 参数校验
        ...
        ThrowUtils.throwIf(oldInterfaceInfo == null, ErrorCode.NOT_FOUND_ERROR);
        // 校验接口是否可以调用
        com.sg.sgapiclientsdk.model.entity.User user = new com.sg.sgapiclientsdk.model.entity.User();
        user.setName("Sg");
...
//        Object clientResult = sgApiClient.parseAddressAndCallInterface(baseRequest);
...
//        }
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest, HttpServletRequest request) {
        ...
        // 创建一个client发送请求
        SgApiClient client = new SgApiClient(secretId, secretKey);
        // 调用sdk自动判断调用接口
        // 调用sdk
        URL url = null;
        try {
